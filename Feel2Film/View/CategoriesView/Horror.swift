        ...
        ZStack() {
            ...
            VStack{
                ...
                HStack {
                    ...
                    Button {
                        viewModel.calculateForHorrorMovies()
                    } label: {
                ...
                VStack(alignment: .leading, spacing: 15) {
                    ...
                    HStack(spacing: 10) {
                        ...
                        Text(viewModel.newHorrorMovies.rating.description)
                    ...
                    HStack{
                        ForEach(viewModel.newHorrorMovies.category , id: \.self){ item in
                            ZStack {
                                Rectangle()
...
struct HorrorMovieView_Previews: PreviewProvider {
    static var previews: some View {
        HorrorMovieView(presentView: .constant(true))
    }
}
