        ...
        ZStack() {
            ...
            VStack{
                ...
                HStack {
                    ...
                    Button {
                        viewModel.calculateForComedyMovies()
                    } label: {
                ...
                VStack(alignment: .leading, spacing: 15) {
                    ...
                    HStack(spacing: 10) {
                        ...
                        Text(viewModel.newComedyMovies.rating.description)
                    ...
                    HStack{
                        ForEach(viewModel.newComedyMovies.category , id: \.self){ item in
                            ZStack {
                                Rectangle()
...
struct ComedyMovieView_Previews: PreviewProvider {
    static var previews: some View {
        ComedyMovieView(presentView: .constant(true))
    }
}
