        ...
        ZStack() {
            ...
            VStack{
                ...
                HStack {
                    ...
                    Button {
                        viewModel.calculateForMysteryMovies()
                    } label: {
                ...
                VStack(alignment: .leading, spacing: 15) {
                    ...
                    HStack(spacing: 10) {
                        ...
                        Text(viewModel.newMystreyMovies.rating.description)
                    ...
                    HStack{
                        ForEach(viewModel.newMystreyMovies.category , id: \.self){ item in
                            ZStack {
                                Rectangle()
...
struct MysteryMovieView_Previews: PreviewProvider {
    static var previews: some View {
        MysteryMovieView(presentView: .constant(true))
    }
}
