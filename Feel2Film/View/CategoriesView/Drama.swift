        ...
        ZStack() {
            ...
            VStack{
                ...
                HStack {
                    ...
                    Button {
                        viewModel.calculateForDramaMovies()
                    } label: {
                ...
                VStack(alignment: .leading, spacing: 15) {
                    ...
                    HStack(spacing: 10) {
                        ...
                        Text(viewModel.newDramaMovies.rating.description)
                    ...
                    HStack{
                        ForEach(viewModel.newDramaMovies.category , id: \.self){ item in
                            ZStack {
                                Rectangle()
...
struct DramaMovieView_Previews: PreviewProvider {
    static var previews: some View {
        DramaMovieView(presentView: .constant(true))
    }
}
